...
const ALL: Product[] = [
  // ── Wine Holders ──────────────────────────────────────────────────────────
  { name: "Riva",  category: "Wine Holders", price: 2900, dimensions: "41.5×41.5×14 cm",
  ...
  { name: "Maison", category: "Wine Holders", price: 3200, dimensions: "40×22×25 cm",
    ...
    images: [`${B}/Maison-wineholder-1..JPG`, `${B}/Maison-wine-holder2.JPG`, `${B}/Maison-wine-holder3.JPG`, `${B}/Maison-wine-holder-b1.JPG`, `${B}/Maison-wine-holderb2.JPG`, `${B}/Maison-wine-holderb3.JPG`] },
  { name: "Clink", category: "Wine Holders", price: 3200, dimensions: "19×14.5×60 cm",
  ...
  { name: "Opera", category: "Wine Holders", price: 2800, dimensions: "40×14.5×39 cm",
  ...
  // ── Vases ─────────────────────────────────────────────────────────────────
  { name: "Luna Vase", category: "Vases", price: 1500, dimensions: "13×10×31 cm",
  ...
  { name: "Maya Vase", category: "Vases", price: 1600, dimensions: "20×20×24 cm",
  ...
  { name: "Terra Vase", category: "Vases", price: 1600, dimensions: "11×11×30 cm",
    ...
    images: [`${B}/Terra-vase-1.JPG`, `${B}/Terra-vase-2.JPG`, `${B}/Terra-vase3.JPG`, `${B}/Terra-vase-peach-1.JPG`, `${B}/Terra-vase-peach2.JPG`, `${B}/Terra-vase-peach3.JPG`, `${B}/Terra-vase-silver-1.JPG`, `${B}/Terra-vase-silver-2.JPG`, `${B}/Terra-vase-silver-3.JPG`] },
  { name: "Cala Vase", category: "Vases", price: 1300, dimensions: "10.5×10.5×20 cm",
    ...
    images: [`${B}/Cala-vase-black1.JPG`, `${B}/Cala-vase-black2.JPG`, `${B}/Cala-vase-black3.JPG`, `${B}/Cala-vase-green-1.JPG`, `${B}/Cala-vase-green2.JPG`, `${B}/Cala-vase-green-3.JPG`] },
  { name: "Aura Vase (S)", category: "Vases", price: 1500, dimensions: "16×16×15 cm",
    ...
    images: [`${B}/Aura-vase-8.JPG`, `${B}/Aura-vase-1.JPG`, `${B}/Aura-vase-2.JPG`, `${B}/Aura-vase-3.JPG`, `${B}/Aura-vase-4.JPG`, `${B}/Aura-vase-5.JPG`] },
  { name: "Aura Vase (M)", category: "Vases", price: 1700, dimensions: "15×15×22 cm",
    description: "Innovative 3-in-1 modular set with playful wavy rims. Use together as a layered centrepiece or separately as individual accents.",
    images: [`${B}/Aura-vase-7.JPG`, `${B}/Aura-vase-1.JPG`, `${B}/Aura-vase-2.JPG`, `${B}/Aura-vase-3.JPG`, `${B}/Aura-vase-4.JPG`, `${B}/Aura-vase-5.JPG`] },
  { name: "Aura Vase (L)", category: "Vases", price: 1900, dimensions: "14×14×30 cm",
    description: "Innovative 3-in-1 modular set with playful wavy rims. Use together as a layered centrepiece or separately as individual accents.",
    images: [`${B}/Aura-vase-6.JPG`, `${B}/Aura-vase-1.JPG`, `${B}/Aura-vase-2.JPG`, `${B}/Aura-vase-3.JPG`, `${B}/Aura-vase-4.JPG`, `${B}/Aura-vase-5.JPG`] },

  // ── Shoe Racks ────────────────────────────────────────────────────────────
  { name: "Step",  category: "Shoe Display Racks", price: 900,  dimensions: "28×10×24 cm",
  ...
  { name: "Vault", category: "Shoe Display Racks", price: 6500, dimensions: "31×27×61 cm",
  ...
  { name: "Orbit", category: "Shoe Display Racks", price: 5500, dimensions: "44×37.5×84 cm",
  ...
  { name: "Align", category: "Shoe Display Racks", price: 3600, dimensions: "82.5×26×271 cm",
  ...
  { name: "Penta", category: "Shoe Display Racks", price: 3800, dimensions: "106.5×26×33 cm",
  ...
  // ── Organisers ────────────────────────────────────────────────────────────
  { name: "Linea Organiser", category: "Organisers", price: 2100, dimensions: "15.5×10×45 cm",
    ...
    images: [`${B}/Linea-organiser-green.JPG`, `${B}/Linea%20organiser-green2.JPG`, `${B}/Linea%20organiser%20light%20green%20.JPG`, `${B}/Linea-organiser-white.JPG`, `${B}/Linea-organiser-white-2.JPG`, `${B}/Linea-organiser-white3.JPG`] },
  { name: "Perch Organiser", category: "Organisers", price: 8000, dimensions: "73×15×40 cm",
  ...
  { name: "Nest Organiser", category: "Organisers", price: 4500, dimensions: "61×13×61 cm",
  ...
  // ── Shelves (sample — full list in shelves/page.tsx) ──────────────────────
  { name: "Verse",    category: "Shelves", type: "Wall-mounted",  price: 3500,  dimensions: "36×14×59 cm",    description: "A harmonious blend of form and function, inspired by the fluidity of poetry.", images: [`${B}/shelf1.png`] },
  { name: "Narrative",category: "Shelves", type: "Free Standing", price: 39500, dimensions: "72×19×150 cm",   description: "Embodies the intricate journey of storytelling, with a design that blends bold straight lines and graceful curves.", images: [`${B}/Narrative-bookshelf1.png`, `${B}/Narrative-bookshelf2.png`, `${B}/Narrative-bookshelf3.png`] },
  { name: "Sonnet",   category: "Shelves", type: "Wall-mounted",  price: 6500,  dimensions: "14×11×96 cm",    description: "A sleek, long bookshelf with a subtle, almost invisible design, creates the illusion of floating books.", images: [`${B}/sonnet-bookshelf.png`] },
  { name: "Scroll",   category: "Shelves", type: "Wall-mounted",  price: 8500,  dimensions: "30×11×96 cm",    description: "A sophisticated invisible bookshelf designed to blend functionality with modern elegance.", images: [`${B}/scroll-bookshelf1.png`, `${B}/scroll-bookshelf2.png`] },
  { name: "Saga",     category: "Shelves", type: "Wall-mounted",  price: 7500,  dimensions: "64×11×87 cm",    description: "A unique invisible bookshelf crafted to transform your book collection into a dynamic display.", images: [`${B}/Saga-bookshelf1.png`] },
  { name: "Chapter",  category: "Shelves", type: "Table Top",     price: 7000,  dimensions: "44×25×80 cm",    description: "Combines functionality with soft, rounded edges for a modern, inviting look.", images: [`${B}/Chapter-bookshelf1.png`, `${B}/Chapter-bookshelf2.png`] },
];

export function getProductBySlug(catSlug: string, prodSlug: string): Product | null {
  return ALL.find(
    (p) => toSlug(p.category) === catSlug && toSlug(p.name) === prodSlug
  ) ?? null;
}

export function getProductsByCategory(catSlug: string): Product[] {
  return ALL.filter((p) => toSlug(p.category) === catSlug);
}
