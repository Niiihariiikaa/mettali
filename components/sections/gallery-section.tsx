...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/decor1.png", alt: "Mettali aluminium home decor" },
    { src: "/images/decor2.png", alt: "Mettali aluminium accent pieces" },
    { src: "/images/decor3.png", alt: "Mettali aluminium in a modern living room" },
    { src: "/images/decor7.png", alt: "Mettali decor in a refined interior" },
  ];
