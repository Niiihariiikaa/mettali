        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", paddingRight: 32 }}>
                <p className="h2s-sub" style={{
                  fontSize: 12, lineHeight: 1.85,
                  color: "rgba(255,255,255,0.58)",
                  maxWidth: 270, fontFamily: SPACE_MONO,
                }}>
                  Aluminium decor that brings calm,<br />
                  balance and character to your space.
                </p>

                <div className="h2s-scr" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
                  <span style={{
